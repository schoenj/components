...
var PsFormBaseModule = /** @class */ (function () {
    function PsFormBaseModule() {
    }
    PsFormBaseModule.forRoot = function (formsServiceType) {
        return {
...
/* harmony import */ var _prosoft_components_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @prosoft/components/utils */ "../components/utils/index.ts");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ "../../node_modules/rxjs/_esm5/index.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/operators */ "../../node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./helpers */ "../components/form-base/src/helpers.ts");
...
var PsFormService = /** @class */ (function () {
    function PsFormService() {
    }
    return PsFormService;
}());

var BasePsFormService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](BasePsFormService, _super);
    function BasePsFormService() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.options = {
            debounceTime: 100,
            includeControlsDefault: false,
        };
        _this.tryDetectRequired = true;
        _this.getControlType = _helpers__WEBPACK_IMPORTED_MODULE_5__["getControlType"];
        return _this;
    }
    BasePsFormService.prototype.getControlErrors = function (control) {
        return this.getErrors(control, true, 'control');
    };
    BasePsFormService.prototype.getFormErrors = function (form, includeControls) {
     ...
     */
    BasePsFormService.prototype.filterErrors = function (errorData, includeControls, source) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(errorData);
    };
    BasePsFormService.prototype.getErrors = function (control, includeControls, source) {
        var _this = this;
        var update$ = this.createUpdateTrigger(control);
        return update$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function () { return _this.getErrorInfo(control, includeControls); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (errorData) { return _this.filterErrors(errorData, includeControls, source); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (errorData) { return _this.mapDataToError(errorData); }));
    };
    BasePsFormService.prototype.createUpdateTrigger = function (control) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"])(control.valueChanges, control.statusChanges).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(this.options.debounceTime));
    };
    BasePsFormService.prototype.getErrorInfo = function (control, includeControls) {
        if (includeControls === void 0) { includeControls = false; }
        return this.getControlErrorInfoInternal(control, '', includeControls);
    };
    BasePsFormService.prototype.getControlErrorInfoInternal = function (control, controlPath, includeControls) {
        var _this = this;
        var errors = [];
        if (control instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"] || control instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormArray"]) {
            for (var childName in control.controls) {
                if (!control.controls.hasOwnProperty(childName)) {
                    continue;
                }
                var childControl = control.controls[childName];
                if (!(childControl instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]) || includeControls) {
                    errors.push.apply(errors, this.getControlErrorInfoInternal(childControl, controlPath ? controlPath + '.' + childName : childName, includeControls));
                }
            }
        }
        if (control.errors) {
            errors.push.apply(errors, Object(_prosoft_components_utils__WEBPACK_IMPORTED_MODULE_2__["objectToKeyValueArray"])(control.errors).map(function (error) { return _this.createFormErrorData(error, control, controlPath); }));
        }
        return errors;
    };
    BasePsFormService.prototype.createFormErrorData = function (error, control, controlPath) {
        return {
            controlPath: controlPath,
            errorKey: error.key,
            errorValue: error.value,
            isControl: control instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"],
        };
    };
    return BasePsFormService;
}(PsFormService));
...
function hasRequiredField(abstractControl) {
    ...
    if (abstractControl instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormGroup"] || abstractControl instanceof _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormArray"]) {
        var controls = abstractControl.controls; // any because of https://github.com/microsoft/TypeScript/issues/32552
...
function getControlType(control) {
    var controlId = control.id /* MatFormFieldControl, z.B. checkbox */ || control.name; /* mat-radio-group */
    if (controlId) {
...
var DummyMatFormFieldControl = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](DummyMatFormFieldControl, _super);
    function DummyMatFormFieldControl(ngControl, formControl) {
        var _this = _super.call(this) || this;
        _this.ngControl = ngControl;
        _this.stateChanges = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        _this.focused = false;
        _this.errorState = false;
        _this.controlType = 'ps-dummy';
        _this._value = null;
        ...
        if (formControl) {
            _this._valueSubscription = formControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["startWith"])(formControl.value)).subscribe(function (value) {
                _this.value = value;
                _this.errorState = formControl.invalid;
            });
            _this._statusSubscription = formControl.statusChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["startWith"])(formControl.status)).subscribe(function () {
                _this.errorState = formControl.invalid;
            });
        }
        return _this;
    }
    Object.defineProperty(DummyMatFormFieldControl.prototype, "required", {
        get: function () {
    ...
    Object.defineProperty(DummyMatFormFieldControl.prototype, "disabled", {
        get: function () {
    ...
    Object.defineProperty(DummyMatFormFieldControl.prototype, "value", {
        get: function () {
            return this._value;
        },
        set: function (value) {
    ...
    Object.defineProperty(DummyMatFormFieldControl.prototype, "empty", {
        get: function () {
            return !this.value;
        },
        enumerable: true,
    ...
    Object.defineProperty(DummyMatFormFieldControl.prototype, "shouldLabelFloat", {
        get: function () {
    ...
    DummyMatFormFieldControl.prototype.onContainerClick = function (_) { };
    DummyMatFormFieldControl.prototype.setDescribedByIds = function (_) { };
    DummyMatFormFieldControl.prototype.ngOnDestroy = function () {
    ...
    DummyMatFormFieldControl.prototype.writeValue = function (_) { };
    DummyMatFormFieldControl.prototype.registerOnChange = function (_) { };
    DummyMatFormFieldControl.prototype.registerOnTouched = function (_) { };
    DummyMatFormFieldControl.prototype.setDisabledState = function (_) { };
    return DummyMatFormFieldControl;
}(_angular_material_form_field__WEBPACK_IMPORTED_MODULE_1__["MatFormFieldControl"]));
...
var PS_FORM_FIELD_CONFIG = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('PS_FORM_FIELD_CONFIG');
var PsFormFieldComponent = /** @class */ (function () {
    function PsFormFieldComponent(_elementRef, formsService, defaults) {
    ...
    Object.defineProperty(PsFormFieldComponent.prototype, "labelChild", {
    ...
    Object.defineProperty(PsFormFieldComponent.prototype, "showBubble", {
        get: function () {
    ...
    Object.defineProperty(PsFormFieldComponent.prototype, "showErrorBubble", {
        get: function () {
    ...
    Object.defineProperty(PsFormFieldComponent.prototype, "autoResizeHintError", {
        get: function () {
    ...
    Object.defineProperty(PsFormFieldComponent.prototype, "hintToggleOptionActive", {
    ...
    Object.defineProperty(PsFormFieldComponent.prototype, "showHintToggle", {
        get: function () {
    ...
    Object.defineProperty(PsFormFieldComponent.prototype, "visibleHint", {
        get: function () {
    ...
    PsFormFieldComponent.prototype.ngOnChanges = function (changes) {
        if (changes.hintToggle) {
            this.showHint = !this.hintToggleOptionActive;
        }
    };
    PsFormFieldComponent.prototype.ngAfterContentInit = function () {
        var _this = this;
        ...
        if (this.formControl) {
            ...
            this.errors$ = this.formsService.getControlErrors(this.formControl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (errors) {
                _this.hasError = !!errors.length;
            }));
            this.updateLabel();
        }
    };
    PsFormFieldComponent.prototype.ngOnDestroy = function () {
    ...
    PsFormFieldComponent.prototype.toggleHint = function (event) {
        this.showHint = !this.showHint;
        event.stopPropagation();
    };
    PsFormFieldComponent.prototype.updateLabel = function () {
        var _this = this;
        this.calculatedLabel = null;
        if (!this.createLabel || this._labelChild || !this.formControl) {
            return;
        }
        var labelText$ = this.formsService.getLabel(this.formControl);
        if (!labelText$) {
            return;
        }
        if (this.labelTextSubscription) {
        ...
        this.labelTextSubscription = labelText$.subscribe(function (label) {
            if (_this.controlType.startsWith('mat-checkbox')) {
                var labelNode = _this._elementRef.nativeElement.querySelectorAll('.mat-checkbox-label')[0];
...
var PsFormFieldModule = /** @class */ (function () {
    function PsFormFieldModule() {
    }
    return PsFormFieldModule;
}());
...
//# sourceMappingURL=default~form-field-demo-form-field-demo-module-ngfactory~slider-demo-slider-demo-module-ngfactory-es5.js.map