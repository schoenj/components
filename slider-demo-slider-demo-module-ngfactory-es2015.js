...
/* harmony import */ var _formatter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./formatter */ "../components/slider/src/formatter.ts");
...
const _PsSliderMixinBase = Object(_angular_material_core__WEBPACK_IMPORTED_MODULE_3__["mixinErrorState"])(PsSliderBase);
// tslint:disable-next-line: no-conflicting-lifecycle
class PsSliderComponent extends _PsSliderMixinBase {
    constructor(_parentForm, _parentFormGroup, ngControl, _defaultErrorStateMatcher, el, renderer, cd) {
        ...
        this._uid = `ps-slider-${PsSliderComponent.nextId++}`;
        /**
         ...
         * @docs-private
         */
        this.controlType = 'ps-slider';
        this._required = false;
        this._disabled = false;
        this._max = 100;
        this._min = 0;
        this._rawProvidedValue = null;
        this.valueChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this._formatter = new _formatter__WEBPACK_IMPORTED_MODULE_6__["DefaultFormatter"]();
        this._onChangeFnc = () => { };
        this._onTouchedFnc = () => { };
        if (this.ngControl) {
    ...
    set isRange(v) {
        this._isRange = Object(_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_0__["coerceBooleanProperty"])(v);
    }
    /**
     * Implemented as part of MatFormFieldControl.
     * @docs-private
    ...
    set max(v) {
        this._max = Object(_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_0__["coerceNumberProperty"])(v, this._max);
    }
    ...
    set min(v) {
        this._min = Object(_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_0__["coerceNumberProperty"])(v, this._min);
    ...
    set value(v) {
        ...
        if (v !== this._value) {
            if (this.isRange) {
                const range = [0, 0];
                if (Array.isArray(v)) {
                    range[0] = Object(_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_0__["coerceNumberProperty"])(v[0], this.min);
                    range[1] = Object(_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_0__["coerceNumberProperty"])(v[1], this.max);
                }
                this._value = range;
            }
            else {
                this._value = Object(_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_0__["coerceNumberProperty"])(v);
            }
            if (this._slider) {
    ...
    ngOnInit() {
        ...
        this._slider = nouislider__WEBPACK_IMPORTED_MODULE_5__["create"](this.el.nativeElement.querySelector('div'), inputsConfig);
...
//# sourceMappingURL=slider-demo-slider-demo-module-ngfactory-es2015.js.map