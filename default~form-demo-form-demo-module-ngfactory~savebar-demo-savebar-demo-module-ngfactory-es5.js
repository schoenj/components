...
var PsSavebarRightContentDirective = /** @class */ (function () {
    function PsSavebarRightContentDirective() {
    }
    return PsSavebarRightContentDirective;
}());
...
var PsSavebarComponent = /** @class */ (function () {
    function PsSavebarComponent(intlService, renderer, ngZone, cd) {
    ...
    Object.defineProperty(PsSavebarComponent.prototype, "isHidden", {
        get: function () {
    ...
    Object.defineProperty(PsSavebarComponent.prototype, "isSticky", {
        get: function () {
    ...
    Object.defineProperty(PsSavebarComponent.prototype, "saveDisabled", {
        get: function () {
    ...
    PsSavebarComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    PsSavebarComponent.prototype.ngOnChanges = function (changes) {
        var _this = this;
        ...
        if (changes.form) {
            ...
            if (this.form) {
                ...
                this._formSub = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"])(this.form.valueChanges, this.form.statusChanges).subscribe(function () {
                    _this.cd.markForCheck();
                });
            }
        }
    ...
    PsSavebarComponent.prototype.ngOnDestroy = function () {
    ...
    PsSavebarComponent.prototype.hasObservers = function (emitter) {
        return emitter && !!emitter.observers.length;
    };
    PsSavebarComponent.prototype.updateIntl = function () {
        var intl = this.intlService.get('savebar');
        this.intl = this.intlService.merge(intl, this.intlOverride);
    };
    PsSavebarComponent.prototype.updateSaveKeyListener = function () {
        var _this = this;
        if (this._stopListening) {
            this._stopListening();
        }
        if (this.saveKey) {
            this.ngZone.runOutsideAngular(function () {
                _this._stopListening = _this.renderer.listen('document', 'keydown', _this.onKeydown.bind(_this));
            });
        }
    };
    PsSavebarComponent.prototype.onKeydown = function (event) {
        var _this = this;
        if (event.ctrlKey && event.key === this.saveKey && !this.saveDisabled) {
            if (this.hasObservers(this.save)) {
                event.preventDefault();
                this.ngZone.run(function () { return _this.save.emit(); });
            }
            else if (this.hasObservers(this.saveAndClose)) {
                event.preventDefault();
                this.ngZone.run(function () { return _this.saveAndClose.emit(); });
            }
        }
    };
    return PsSavebarComponent;
}());
...
//# sourceMappingURL=default~form-demo-form-demo-module-ngfactory~savebar-demo-savebar-demo-module-ngfactory-es5.js.map