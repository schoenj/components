...
/*!**********************************************************************************************!*\
  !*** C:/workspace/prosoft-components-demo/node_modules/@angular/material/esm5/slider.es5.js ***!
  \**********************************************************************************************/
...
/* harmony import */ var _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! @angular/cdk/collections */ "../../node_modules/@angular/cdk/esm5/collections.es5.js");
...
var ReferenceColumnComponent = /** @class */ (function () {
    function ReferenceColumnComponent() {
    ...
    return ReferenceColumnComponent;
}());

var FormFieldDemoComponent = /** @class */ (function () {
    function FormFieldDemoComponent(cd) {
        this.cd = cd;
        this.subscriptType = 'single-line';
        this.hintToggle = false;
        ...
        this._error = false;
        for (var ctrlName in this.form.controls) {
            if (!this.form.controls.hasOwnProperty(ctrlName)) {
                continue;
            }
            var ctrl = this.form.controls[ctrlName];
            ctrl.psLabel = ctrlName;
        }
    }
    Object.defineProperty(FormFieldDemoComponent.prototype, "disabled", {
        get: function () {
    ...
    Object.defineProperty(FormFieldDemoComponent.prototype, "error", {
        get: function () {
            return this._error;
        },
        set: function (value) {
            for (var ctrlName in this.form.controls) {
                ...
                var ctrl = this.form.controls[ctrlName];
                if (value) {
                    ctrl.setValidators(function () { return ({
...
var FormFieldDemoModule = /** @class */ (function () {
    function FormFieldDemoModule() {
    }
    return FormFieldDemoModule;
}());
...
//# sourceMappingURL=form-field-demo-form-field-demo-module-ngfactory-es5.js.map